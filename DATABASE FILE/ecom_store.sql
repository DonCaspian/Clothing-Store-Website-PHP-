...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2024 at 03:24 AM
...
(1, 'About Us - Our Story', '\r\nDiscover sustainable fashion at unbeatable prices! At Thrift It E.C., we bring you a curated selection of pre-loved clothing and accessories that blend style, quality, and affordability. Embrace eco-conscious shopping while finding unique pieces that express your individuality. Explore our ever-changing collection today and thrift your way to a more sustainable future!\r\n', 'At Thrift It E.C., we believe in the power of sustainable fashion and the charm of secondhand treasures. Our shop is dedicated to providing you with an exceptional thrifting experience, offering a carefully curated selection of pre-loved clothing, shoes, and accessories for all styles and budgets. From timeless vintage finds to trendy modern pieces, every item in our collection is chosen with quality, style, and sustainability in mind.\r\n\r\nWe’re passionate about making sustainable shopping accessible to everyone. By choosing thrifted items, you’re not only saving money but also contributing to reducing fashion waste and promoting an eco-friendly lifestyle. Our inventory is constantly updated, ensuring that each visit brings new discoveries and one-of-a-kind pieces you won’t find anywhere else. Whether you\'re looking to elevate your wardrobe or hunt for a hidden gem, Thrift It E.C. has something for everyone.');
...
(1, 'thriftitec@mail.com', 'Contact Us', 'If you have any questions, please feel free to contact us, our customer service center is working for you 24/7.');
...
(6, 'Taguig Store', 'store location.jpg', '\r\n<p style=\"text-align: center;\"><strong>333 Dir. A. Bunye, Maynila, Kalakhang Maynila</strong></p>\r\n<p>Discover sustainable fashion at unbeatable prices! At Thrift It E.C., we bring you a curated selection of pre-loved clothing and accessories that blend style, quality, and affordability. Embrace eco-conscious shopping while finding unique pieces that express your individuality. Explore our ever-changing collection today and thrift your way to a more sustainable future!</p>\r\n', 'https://www.google.com/maps/place/Thrift+it+E.C./@14.4635239,121.0679065,15z/data=!4m6!3m5!1s0x3397cf34eb6f555b:0xd0d17958b1845ba9!8m2!3d14.4743718!4d121.0594078!16s%2Fg%2F11t9nrr3jw?entry=ttu&g_ep=EgoyMDI0MTEyNC4xIKXMDSoASAFQAw%3D%3D', 'http://www.ThriftItEC.com/ecommerce');
...
(1, 'Rules And Regulations', 'rules', '<p>At Thrift It E.C., we value fairness, respect, and a positive shopping experience for everyone. Customers are expected to engage respectfully with staff and fellow shoppers, as any form of harassment or disruptive behavior will not be tolerated. To ensure fairness, we kindly ask shoppers to purchase only what they intend to buy, as items left unattended for extended periods may be returned to inventory. For safety and hygiene reasons, all purchased clothing should be washed before use, as items are sold as-is. For online shopping, customers must create an account with accurate information to place orders and track purchases. Please note that orders are processed on a first-come, first-served basis, and items in your cart are not guaranteed until checkout is complete. </p>'),
(2, 'Refund Policy', 'link2', 'Our refund policy ensures fairness while maintaining the integrity of our operations. Refunds are available only for items that are defective, damaged, or misrepresented on our website. Clearance and discounted items are final sale unless proven faulty. To request a refund, customers must contact us within seven days of receiving their order and provide proof of purchase along with photos of the item. Approved refunds will be processed via the original payment method within 7–10 business days. Please note that shipping costs are non-refundable, and customers will bear the cost of return shipping unless the error is on our part.'),
(3, 'Pricing and Promotions Policy', 'link3', 'At Thrift It E.C., we are committed to offering fair and competitive pricing based on the quality, brand, and uniqueness of each item. Any discounts or promotional offers will be clearly communicated with specific validity periods and cannot be combined unless stated otherwise. Price adjustments on items purchased prior to sales or promotions are not available. While we strive for accuracy, typographical errors in pricing may occasionally occur; we reserve the right to correct these errors and cancel orders if necessary. Additionally, prices displayed on our website do not include applicable taxes, which will be calculated at checkout based on your location.');
